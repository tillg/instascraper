...
As taken from [Instagram]()

## Prompt 1: The Multi Perspective Scan

I need to research [THE TOPIC. Simulate 5 different expert perspectives on this topic:
...
3. THE SKEPTIC: thinks the mainstream view is wrong. What i. the strongest counterargument? What evidence do proponents conveniently ignore?
...
For each perspective give me their core position in 2 sentences, the strongest evidence supporting their view, and the one thing they would tell me that no other perspective would.
...
1. CONFIDENCE SCORES: rate each of the 5 key findings on a l to 10 scale for reliability. Explain each score.
